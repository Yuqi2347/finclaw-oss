...
│  └─ templates/            # non-private default templates, including memory
...
├─ runtime/                 # local runtime data: sessions, memory, research, DataHub, capability outputs, logs, caches (git-ignored)
│  ├─ finclaw/data/         # sessions, long-term memory, research threads, research records, audit and observability data
│  ├─ findatahub/data/      # market data, fundamentals, news, refresh logs, and provider usage records
│  └─ capabilities/         # reports, caches, and runtime artifacts generated by capability plugins
├─ docs/
├─ .env.example
├─ LICENSE
└─ NOTICE
