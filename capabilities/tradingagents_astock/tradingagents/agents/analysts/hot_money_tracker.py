...
def create_hot_money_tracker(llm):
    ...
    def hot_money_tracker_node(state):
        ...
        system_message = (
            ...
            "\n4. 优先调用 get_market_package 获取统一市场包，整合市场宽度、热点、北向、概念、资金流、龙虎榜和解禁信号"
            "\n5. 在需要时再调用 get_hot_stocks / get_northbound_flow / get_concept_blocks / get_fund_flow / get_dragon_tiger_board / get_industry_comparison 做局部细化"
            ...
            "\n- `get_market_package(ticker, curr_date)`：获取统一市场包，优先作为市场信号总入口"
