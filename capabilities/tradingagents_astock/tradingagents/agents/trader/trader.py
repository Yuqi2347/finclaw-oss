        ...
        messages = [
            ...
            },
            {
                ...
                "content": (
                    ...
                    f"sentiment, news, fundamentals, and policy specialists, plus any optional "
                    f"A-share enhancement modules that were available), here is an investment "
                    f"plan for {company_name}.\n\n"
