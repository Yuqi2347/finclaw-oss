...
def get_market_package(
    ...
    """
    Retrieve the unified market package for a single A-share ticker.
    Includes market overview, hot stocks, northbound flow, concept blocks,
    individual fund flow, dragon-tiger board, lockup expiry, and industry comparison.
    This is the preferred entry point for market-aware analysis.
    """
    return route_to_vendor("get_market_package", ticker, curr_date, overview_limit, news_limit)
