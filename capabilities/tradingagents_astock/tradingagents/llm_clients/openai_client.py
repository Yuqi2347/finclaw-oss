...
_PROVIDER_CONFIG = {
    ...
    "glm": ("https://api.z.ai/api/paas/v4/", ("ZHIPU_API_KEY", "ZHIPU_CN_API_KEY")),
    "openrouter": ("https://openrouter.ai/api/v1", ("OPENROUTER_API_KEY",)),
    "ollama": ("http://localhost:11434/v1", None),
    "minimax": ("https://api.minimax.chat/v1", ("MINIMAX_API_KEY", "MINIMAX_CN_API_KEY")),
}


def _first_env_value(names: tuple[str, ...] | None) -> str | None:
    if not names:
        return None
    for name in names:
