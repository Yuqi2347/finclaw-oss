...
_FONT_CANDIDATES = [
    _PROJECT_ROOT / "assets" / "fonts" / "NotoSansSC-Regular.ttf",
    _PROJECT_ROOT / "assets" / "fonts" / "NotoSansCJKsc-Regular.otf",
    _PROJECT_ROOT / "assets" / "fonts" / "SourceHanSansCN-Regular.otf",
]


def _find_cjk_font() -> str | None:
    configured = os.getenv("TRADINGAGENTS_CJK_FONT", "").strip()
    if configured:
